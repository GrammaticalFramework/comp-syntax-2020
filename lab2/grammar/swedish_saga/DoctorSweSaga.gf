concrete DoctorSweSaga of Doctor =
  open
    SyntaxSwe,
    ParadigmsSwe,
    Prelude
...
-- end of what could be a functor -- vad betyder detta
--------------------------------
  ...
  measureBloodPressureAction = mkVP (mkV2 (mkV "mäter")) (mkNP the_Det (mkN "blodtryck")) ;
  ...
  hypertensionIllness = mkNP (mkN "högt blodtryck") ;

  alcoholSubstance = mkNP (mkN "alkohol") ;
  medicineSubstance = mkNP a_Det (mkN "läkemedel") ;
