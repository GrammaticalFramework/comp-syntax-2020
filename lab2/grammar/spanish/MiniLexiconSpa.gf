concrete MiniLexiconSpa of MiniLexicon = MiniGrammarSpa **
  ...
  in {
    ...
    lin cold_A = mkA "frío" ;
    lin come_V = mkV "venir" "venido" "vengo" "vienes" "viene" "venimos" "venìs" "vienen" "ven" "vengamos" "venid" "vengas" "vengamos" "vengàis" ;
    ...
    lin find_V2 = mkV2 (mkV "encontrar" "encontrado" "encuentro" "encuetras" "encuentra" "encontramos" "encontràis" "encuentran" "encuentra" "encontremos" "encontrad" "encuentres" "encontremos" "encontréis") ;
    ...
    lin go_V = mkV "ir" "ido" "voy" "vas" "va" "vamos" "vais" "van" "ve" "vamos" "id" "vayas" "vayamos" "vayàis" ;
    ...
    lin know_VS = mkVS (mkV "saber" "sabido" "sé" "sabes" "sabe" "sabemos" "sabéis" "saben" "sabe" "sepamos" "sabed" "sepas" "sepamos" "sepàis") ; 
    lin language_N = mkN "idioma" M ;
    lin live_V = mkV "vivir" ;
    lin love_V2 = mkV2 (mkV "querer" "querido" "quiero" "quieres" "quiere" "queremos" "queréis" "quieren" "quiere" "queramos" "quered" "quieras" "queramos" "queràis") ;
    ...
    lin sea_N = mkN "mar" F ;
    lin see_V2 = mkV2 (mkV "ver" "visto" "veo" "ves" "ve" "vemos" "veis" "ven" "ve" "veamos" "ved" "veas" "veamos" "veàis") ; 
    lin ship_N = mkN "nave" F ;
    lin sleep_V = mkV "dormir" "dormido" "duermo" "duermes" "duerme" "dormimos" "dormìs" "duermen" "duerme" "durmamos" "dormid" "duermas" "durmamos" "durmàis" ;
    ...
    lin understand_V2 = mkV2 (mkV "entender" "entendido" "entiendo" "entiendes" "entiende" "entendemos" "entendéis" "entienden" "entiende" "entendamos" "entended" "entiendas" "entendamos" "entendàis") ;
